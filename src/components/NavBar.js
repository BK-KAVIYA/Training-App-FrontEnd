                            ...
                            <>
                                {
                                    localStorage.getItem('username') === 'admin' && ( 
                                        <Link to="/dashadmin" className="text-white hover:bg-blue-700 px-3 py-2 rounded-md text-sm font-medium">Home</Link>
                                )}

                                {
                                    localStorage.getItem('username') !== 'admin' && (
                                        <Link to="/dashuser" className="text-white hover:bg-blue-700 px-3 py-2 rounded-md text-sm font-medium">Home</Link>
                                    )
                                }
